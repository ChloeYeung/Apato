...
exports.seed = async function(knex) {
  ...
  await knex('company_product').insert([
    ...
    {id: 3, company_id: 2, name: "Music", description: "Guitar", stock: "100", price: "350", tag: "music", type: "Service"},
    {id: 4, company_id: 2, name: "Dance", description: "Dance", stock: "50", price: "350", tag: "dance", type: "Service"},
  ]);
};
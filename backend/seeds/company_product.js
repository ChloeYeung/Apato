...
exports.seed = async function(knex) {
  ...
  await knex('company_product').insert([
    ...
    {id: 5, company_id: 2, name: "Marketing Consultation", description: "Identify effective marketing campaigns that will effectively and efficiently reach targeted audiences", stock: "2", price: "0.018", tag: "marketing", type: "Service"},

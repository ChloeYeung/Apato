...
class CustomerRouter {
  ...
  router() {
    ...
    //purchase
    router.post(
      "/purchase_show_order_total",
      this.showOrderTotalPurchase.bind(this)
    );
    router.post("/purchase_del_cart", this.delCartInPurchase.bind(this));
    router.post(
      "/purchase_add_order_history",
      this.addOrderHistoryPurchase.bind(this)
    );
    router.post(
      "/purchase_update_company_stock",
      this.updateCompanyStockPurchase.bind(this)
    );
    //order history
  ...
  async addCart(req, res) {
    ...
    let response = await this.CustomerService.addCart(
      token,
      id,
      name,
      description,
  ...
  async addCartService(req, res) {
    ...
    console.log(req.body.add);
    let response = await this.CustomerService.addCartService(
      token,
      id,
      name,
      description,
  ...
  async addCartUnit(req, res) {
    ...
    let response = await this.CustomerService.addCartUnit(
      token,
      cart_id,
      product_id
    );
  ...
  async minusCartUnit(req, res) {
    ...
    let response = await this.CustomerService.minusCartUnit(
      token,
      cart_id,
      product_id
    );

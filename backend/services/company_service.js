class CompanyService {
  ...
  async showProductManagement(token) {
    try {
      ...
      console.log("Error Service company showProductManagement ");
      console.log(error);
    }
  }
  ...
  async deleteProductManagement(token, id) {
    try {
      ...
      console.log("Error in Service company deleteProductManagement");
      console.log(error);
    }
  }
  ...
  async editProductManagement(token, id, column, value) {
    try {
      ...
      console.log("Error in Service company editProductManagement");
      console.log(error);
    }
  }
